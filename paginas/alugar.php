...
background-size: cover;">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="col">
                                ...
                                <input style="width:100%" type="text" id="cpfInput" oninput="formatarCPF(this)">
                            </div>
                            <!--<div class="col">
                  ...
                  -->
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <div class="col">
                                <select id="pagamento" name="pagamento" required onchange="mostrarCamposCartao()"
                                    required onchange="mostrarcampopix()">
                    ...
                    <div class="row justify-content-end">
                        <form action="../paginas/conexao_alugar.php" method="get">
                            ...
                            <button style="margin-left: 790px; width: 120px;" type="submit"
                                onclick="alugarCarro()">Alugar</button>
    ...
    function formatarCPF(input) {
        ...
        // Adiciona pontos e traço conforme o formato desejado
